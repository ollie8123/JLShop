...
public class AddressController {
	...
	public Result updateAddressIsDefault (@RequestBody NormalAddress address,@CookieValue (name ="jwt")String cookieValue) {
	...
	public Result createStoreAddress (@RequestBody ConvenienceStoreAddress storeAddress,@CookieValue (name ="jwt")String cookieValue) {
