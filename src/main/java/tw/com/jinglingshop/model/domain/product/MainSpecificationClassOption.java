...
@Entity
@Data
@Table(name = "[main_specification_class_option]")
public class MainSpecificationClassOption {
	...
	@JsonIgnore
	@ToString.Exclude
	@OneToMany(cascade = CascadeType.ALL, mappedBy = "mainSpecificationClassOption")
